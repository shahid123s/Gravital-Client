...
function SettingsContent() {
    ...
    return (
        <div className='bg-[#4A90E2] w-full ml-[608px] flex-col flex p-5 gap-14 '>
        ...
        {loading && <Spinner/>}
           ...
           {!loading && userDetails && <>
            <div className='bg-inherit'>
                ...
                <div className='bg-[#757575] rounded-xl mx-10 p-3 my-5 flex justify-between items-center'>
            ...
            <div className='bg-inherit'>
                ...
                <div className='bg-[#757575] rounded-xl mx-10 p-3 my-5 h-52 flex justify-between items-center'>
                    <textarea type="text" className='w-full text-white  p-5 h-full  rounded-2xl border-[#757575] text-start' name='bio' value={userDetails.bio} onChange={handleChange} />
                </div>
            </div>

            <div className='bg-inherit'>
                <h1 className='text-2xl font-poppins text-white font-normal'>Gender</h1>
                <div className='bg-[#757575] rounded-xl mx-10 p-3 my-5 flex flex-col justify-between items-center' >
                    <div className='bg-inherit flex justify-between w-full' onClick={handleDropDown}>
                    ...
                    {genderDropDown && <div className='bg-[#333333] rounded-xl p-3 flex flex-col gap-3 text-white  w-full justify-center'>
                        <h1 className='bg-[#333333] hover:bg-[#757575] rounded-xl  p-1' onClick={() => handleGender('male')}>Male</h1>
                        <h1 className='bg-[#333333] hover:bg-[#757575]  rounded-xl  p-1' onClick={() => handleGender('female')}>Female</h1>
                    </div>}
                </div>
            </div> 
            <button className={`font-poppins bg-[#333333] p-4 text-white h-fit w-fit ml-auto rounded-2xl ${
    isChanged ? 'opacity-100 cursor-pointer' : 'opacity-90 cursor-not-allowed'
